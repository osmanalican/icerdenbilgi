  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {errors.position?.message && <p className={errorClassName}>{errors.position.message}</p>}
      </div>
      ...
      <div>
        ...
        {errors.type?.message && <p className={errorClassName}>{errors.type.message}</p>}
      </div>
      ...
      <div>
        ...
        {errors.title?.message && <p className={errorClassName}>{errors.title.message}</p>}
      </div>
      ...
      <div>
        ...
        {errors.content?.message && <p className={errorClassName}>{errors.content.message}</p>}
      </div>
