  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md items-center px-6 py-16">
      <div className="w-full">
        ...
        <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">{children}</div>

        <p className="mt-6 text-center text-sm text-zinc-500">
          {footerText}{' '}
          <Link to={footerLinkTo} className="font-medium text-zinc-950 hover:underline">
            {footerLinkText}
          </Link>
        </p>
      </div>
